/**********************************************************
 * Assignment: recursive exponent calulator
 *
 * Author: Eli Bildman
 *
 * Description: uses itteration then recursion to find a given exponent of a given number
 *
...
public class Powers 
{
	...
	private static double powerUsingRecursion(int base, int exp)
	{
		if (exp == 1) {
			...
			return powerUsingRecursion(base, exp / 2) * powerUsingRecursion(base, exp / 2);
		} else {
