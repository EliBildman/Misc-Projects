 ...
 * Author: Eli Bildman
 *
 * Description: takes an expression with two operands and an operator, the expression solved and reduced to lowest terms in mixed number for if possible		
 *
...
public class FractionalCalculator
{
	public static void main(String[] args) {
		...
		while (!input.toLowerCase().equals("quit")) {
			System.out.println(convertToMixed(reduce(calculate(convertToFraction(findOperand(input, 0)), findOperator(input) + "", convertToFraction(findOperand(input, 1))))));
